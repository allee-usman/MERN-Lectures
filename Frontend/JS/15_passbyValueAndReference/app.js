...
/*
n the background, the “=” (assign operator) allocates some space in the memory, stores the value “3” and returns the location of the allocated memory space. Therefore, the variable x in the above code points to the location of the memory space instead of pointing to the value 3 directly.
*/
...
function checkIn(flight, passenger) {
	...
	if (passenger.passport === 12345) {
		console.log(
			`Hello ${passenger.name}, you are checked for flight number ${flight}.`
		);
	} else {
