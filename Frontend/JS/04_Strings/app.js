...
// console.log(regNum); // output: L1S22BSSE0074@UCP.EDU.PK

//output using Literals
...
// console.log(myName.anchor('ali')); // output: <a name="ali">Ali Usman</a>
...
// console.log(myName.big()); //output: <big>Ali Usman</big>

//#4: bold() - creates a string that embeds this string in a <b> element (<b>str</b>), which causes this string to be displayed as bold.
// console.log(myName.bold()); //output: <b>Ali Usman</b>

//#5: charCodeAt() - returns an integer between 0 and 65535 representing the UTF-16 code unit at the given index.
// console.log(myName.charCodeAt(1)); //output: A -> 108

//#8 concat() - concatenates the string arguments to the calling string and returns a new string.
const newStr = myName.concat(regNum);
// console.log(newStr); //output: Ali UsmanL1S22BSSE0074@UCP.EDU.PK
...
// console.log(myName.padEnd(20,'*')); //output: 'Ali Usman***********'
// console.log(myName.padEnd(12)); //output: 'Ali Usman   '
...
// console.log(myName.padStart(20,'*')); //output: '***********Ali Usman'
// console.log(myName.padStart(12)); //output: '   Ali Usman'
...
// const mood = 'Happy! ';
// console.log(`I feel ${mood.repeat(3)}`); // output output: "I feel Happy! Happy! Happy! "
...
// console.log(newParagraph); // output output: "I think my dog is cuter than your dog!"

// const paragraph = "I think Ruth's dog is cuter than your dog!";
// const newParagraph = paragraph.replace("dog", 'monkey');
// console.log(newParagraph); // output output: "I think my monkey is cuter than your dog!"
...
// console.log(newParagraph); // output output: "I think my monkey is cuter than your monkey!"
...
// const str = 'Banana'
// console.log(str.search('n')); //output: 2
...
// console.log(slicedRegNum); //output: L1S22BSSE0074@UCP.EDU.PK
// let slicedMyName = str.slice(18, 27);
// console.log(slicedMyName); //output: Ali Usman
// let negSlicedMyName = str.slice(-59, -49);
// console.log(negSlicedMyName); //output: Ali Usman
// let negSlicedRegNum = str.slice(-24);
// console.log(negSlicedRegNum); //output: L1S22BSSE0074@UCP.EDU.PK
...
// console.log(words[3]); // output output: "name"

// const chars = str.split('');
// console.log(chars); // Array of characters
// console.log(chars[8]); // output output: "y"

// const strCopy = str.split();
// console.log(strCopy); // output output: Array ["Hello, my name is Ali Usman and my registration # is L1S22BSSE0074@UCP.EDU.PK"]
...
// console.log(myName.startsWith('A')); //output: true
// console.log(myName.startsWith('a')); //output: false
...
// let str = '    Ali Usman    '
// console.log(str); //output: '    Ali Usman    '
// console.log(str.trim()); //output: 'Ali Usman'
